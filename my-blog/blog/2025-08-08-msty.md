...
description: "Skip the monthly AI subscriptions — Msty lets you connect Claude, GPT-4, and Gemini via API keys and pay only for what you actually use, with local model support and built-in document Q&A."
