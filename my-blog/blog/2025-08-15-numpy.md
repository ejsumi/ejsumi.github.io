...
description: "Practical NumPy reference covering array creation, indexing, broadcasting, linear algebra, random number generation, and utility functions — with concise code examples for scientific computing in Python."
tags: [Python, Data Analysis, Personal Project]
---
...
**Related posts:**
- [Pandas Quick Reference](/2025/08/01/pandas) — built on NumPy, adds DataFrames and tabular data tools
